...
$dirNosotrosImg = '/home/u839374897/domains/talento.batidospitaya.com/public_html/uploads/nosotros';
if (!is_dir($dirNosotrosImg)) {
    if (!mkdir($dirNosotrosImg, 0755, true)) {
