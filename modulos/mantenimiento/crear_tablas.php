...
try {
    ...
    // Array con todas las queries de creación
    $queries = [
        'mtto_tipos_casos' => "
    ...
    $tables = ['mtto_tipos_casos', 'mtto_equipos', 'mtto_tickets', 'mtto_chat_mensajes'];
    
    foreach ($tables as $table) {
        try {
            $count = $pdo->query("SELECT COUNT(*) FROM $table")->fetchColumn();
            echo "✅ <strong style='color: green;'>$table</strong> - $count registros<br>";
        } catch (Exception $e) {
    ...
    echo "<p>Las tablas han sido creadas y los datos iniciales insertados.</p>";
