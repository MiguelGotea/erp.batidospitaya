...
if (!tienePermiso('registro_equipos', 'vista', $cargoOperario)) {
                ...
                <form method="POST" id="form-equipo" onsubmit="return validarFormulario()">
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
                        <div class="form-group">
                            ...
                            <input type="text" name="marca" class="form-control" placeholder="Ej: Dell, HP, Canon">
                        </div>

                        <div class="form-group">
                            <label class="form-label">Modelo</label>
                            <input type="text" name="modelo" class="form-control" placeholder="Ej: Latitude 5520">
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="form-label">Número de Serie</label>
                        <input type="text" name="serial" class="form-control" placeholder="Serial del fabricante">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="garantia_meses" class="form-control" value="0" min="0" max="120"
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="frecuencia_mantenimiento_meses" class="form-control" value="3"
