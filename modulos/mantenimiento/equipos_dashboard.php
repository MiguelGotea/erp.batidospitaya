    ...
    <div class="container-main">
        <div class="page-header">
            <div>
                ...
                <p style="color: #666; margin-top: 5px;">Código: <strong><?= htmlspecialchars($equipo['codigo']) ?></strong></p>
            </div>
        ...
        <div class="info-grid">
            <div class="info-card">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value badge badge-info"><?= htmlspecialchars($equipo['ubicacion_actual'] ?? 'Sin ubicación') ?></span>
                </div>
            </div>
            ...
            <div class="info-card">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value"><?= $equipo['fecha_compra'] ? date('d/m/Y', strtotime($equipo['fecha_compra'])) : '-' ?></span>
                </div>
                <div class="info-row">
        ...
        <div class="dashboard-grid">
            ...
            <div class="stat-card">
                ...
                <div class="stat-value" style="color: #28a745;"><?= $estadisticas['mantenimientos_preventivos'] ?></div>
            </div>
            <div class="stat-card">
                <div class="stat-label">Correctivos</div>
                <div class="stat-value" style="color: #ffc107;"><?= $estadisticas['mantenimientos_correctivos'] ?></div>
            </div>
            <div class="stat-card">
                <div class="stat-label">Costo Total Repuestos</div>
                <div class="stat-value" style="color: #dc3545;">C$ <?= number_format($estadisticas['costo_total_repuestos'], 2) ?></div>
            </div>
            <div class="stat-card">
        ...
        <div class="info-card" style="margin-bottom: 30px;">
            <h3 style="margin-bottom: 15px; color: #0E544C;">📅 Plan de Mantenimiento Preventivo <?= date('Y') ?></h3>
        ...
        <div class="info-card" style="margin-bottom: 30px;">
            ...
            <div class="timeline">
                ...
                <div class="timeline-item">
                    ...
                    <div>
                        <span class="badge <?= $mant['tipo'] == 'preventivo' ? 'badge-success' : 'badge-warning' ?>">
                            <?= ucfirst($mant['tipo']) ?>
                        </span>
                    </div>
        ...
        <div class="info-card">
            ...
            <div class="timeline">
                ...
                <div class="timeline-item">
                    ...
                    <div>
                        <span class="badge <?= $mov['estado'] == 'finalizado' ? 'badge-success' : 'badge-warning' ?>">
                            <?= ucfirst($mov['estado']) ?>
                        </span>
                    </div>
                    <div style="margin-top: 10px;">
