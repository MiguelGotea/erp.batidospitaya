            ...
            <div class="mb-3">
                ...
                <div class="d-flex align-items-center gap-2">
                    <div class="d-flex flex-grow-1 urgency-compact-buttons">
                        <button type="button"
                            class="btn btn-sm urgency-compact urgency-level-1 <?= ($ticket['nivel_urgencia'] == 1) ? 'selected' : '' ?>"
                            data-level="1" onclick="selectUrgency(1)" title="Baja" <?= !$puedeEditar ? 'disabled' : '' ?>>
                            <small>1</small>
                        </button>
                        <button type="button"
                            class="btn btn-sm urgency-compact urgency-level-2 <?= ($ticket['nivel_urgencia'] == 2) ? 'selected' : '' ?>"
                            data-level="2" onclick="selectUrgency(2)" title="Media" <?= !$puedeEditar ? 'disabled' : '' ?>>
                            <small>2</small>
                        </button>
                        <button type="button"
                            class="btn btn-sm urgency-compact urgency-level-3 <?= ($ticket['nivel_urgencia'] == 3) ? 'selected' : '' ?>"
                ...
                <input type="hidden" id="edit_nivel_urgencia" name="nivel_urgencia"
            ...
            <div class="photos-grid-edit">
                <?php foreach ($fotos as $index => $foto): ?>
                    <div class="photo-item-edit" data-foto-id="<?= $foto['id'] ?>">
                        <img src="uploads/tickets/<?= $foto['foto'] ?>" alt="Foto <?= $index + 1 ?>" class="img-thumbnail"
