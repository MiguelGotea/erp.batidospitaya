    ...
    <div class="modal-body">
        <form id="formDetallesTicket">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="titulo_detalles"
                        value="<?= htmlspecialchars($ticket['titulo']) ?>" <?= !$puedeEditar ? 'readonly' : '' ?>
                        required>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <?php else: ?>
                        ...
                        <div class="urgencia-selector-compacto"
                            style="background-color: <?= $colorActual ?>; cursor: default;">
                            <?= $textoActual ?>
                        </div>
                    <?php endif; ?>
                </div>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="descripcion_detalles" rows="4" <?= !$puedeEditar ? 'readonly' : '' ?>
