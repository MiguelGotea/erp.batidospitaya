                    ...
                    <form id="formCliente">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="nombre" name="nombre" required <?php echo !$puedeEditar ? 'disabled' : ''; ?>>
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="apellido" class="form-label">Apellido</label>
                                <input type="text" class="form-control" id="apellido" name="apellido" <?php echo !$puedeEditar ? 'disabled' : ''; ?>>
                            </div>
                            <div class="col-md-4 mb-3">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="celular" name="celular" <?php echo !$puedeEditar ? 'disabled' : ''; ?>>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="correo" class="form-label">Correo Electrónico</label>
                                <input type="email" class="form-control" id="correo" name="correo" <?php echo !$puedeEditar ? 'disabled' : ''; ?>>
                            </div>
                        </div>
