...
function obtenerFaltasAutomaticasParaContabilidad($codSucursal, $fechaDesde, $fechaHasta) {
    ...
    foreach ($operarios as $operario) {
        ...
        foreach ($diasLaborables as $dia) {
            // 3. Verificar si NO hay marcación de entrada para ese día, filtrando por sucursal
            $marcacion = obtenerMarcacionEntrada($operario['CodOperario'], $dia['fecha'], $operario['cod_sucursal']);
