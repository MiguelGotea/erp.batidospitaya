    ...
    <style>
        ...
        * {
        ...
        .tabla-pedido td {
            ...
            padding: clamp(5px, 1.5vw, 12px) clamp(3px, 1vw, 5px);
            /* Padding responsive */
        }
        ...
        @media (max-width: 768px) {
            ...
            .btn-header {
                padding: 6px 10px;
                /* Padding más ajustado para móviles */
            }
...
<body>
    <header class="header-ventas">
        <img src="../../../core/assets/img/Logo.svg" alt="Batidos Pitaya" class="logo-ventas">
    ...
    <main class="container-ventas">
        ...
        <section class="pedido-section">
            ...
            <div class="cliente-section" style="margin-bottom: 15px;">
                <label for="nombreCliente" style="display: block; margin-bottom: 5px; color: #666;">Nombre del
                    Cliente</label>
