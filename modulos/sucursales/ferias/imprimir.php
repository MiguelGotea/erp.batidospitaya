...
<head>
    ...
    <style>
        ...
        .separator {
            height: 10mm; /* Espacio entre comanda y factura */
            position: relative;
        }
        .separator::after {
            content: "";
        ...
        @media print {
            ...
            .cut::after {
                content: "\00000C"; /* Carácter de control para corte (form feed) */
                display: block;
                font-size: 0;
                height: 0;
            }
            ...
            .factura::after {
                content: "";
                display: block;
                height: 50mm; /* Espacio para el corte manual */
            }
        }
    </style>
</head>
<body>
    ...
    <div class="factura" style="margin-top:57px; margin-bottom:45px;">
        <div class="logo">
            <img src="/assets/img/Logo.svg" alt="Batidos Pitaya">
        </div>
