                            ...
                            <div class="card h-100 border-0 bg-light">
                                <div class="card-body">
                                    ...
                                    <p class="small text-muted mb-0">
                                        Sube una foto clara de la factura para que la IA extraiga los conceptos y montos
                                        automáticamente.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="card h-100 border-0 bg-light">
                                <div class="card-body">
                                    ...
                                    <p class="small text-muted mb-0">
                                        El sistema auto-completa los datos bancarios del proveedor seleccionado para
                                        facilitar el pago.
                                    </p>
                                </div>
                            </div>
