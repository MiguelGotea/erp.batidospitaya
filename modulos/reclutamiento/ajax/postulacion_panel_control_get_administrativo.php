<?php
// postulacion_panel_control_get_administrativo.php

require_once '../../../core/database/conexion.php';
header('Content-Type: application/json');

try {
    // Obtener cargos administrativos (todos EXCEPTO producción y ventas/sucursales)
    // Excluir: 20, 23, 34 (producción) y 2, 5, 43, 44, 45, 46, 47 (ventas/sucursales)
    $sql = "SELECT 
                nc.CodNivelesCargos as cod_cargo,
                nc.Nombre as nombre_cargo,
                nc.Area as area_cargo,
                COALESCE(nc.especialidad_area, '') as especialidad_area,
            ...
            LEFT JOIN plazas_cargos pc ON nc.CodNivelesCargos = pc.cargo AND pc.area = 'Administrativo'
            WHERE nc.CodNivelesCargos NOT IN (2, 5, 20, 23, 34, 43, 44, 45, 46, 47, 27, 17, 19, 12, 9, 10) -- Cargos que no saldrán en la pestaña Administrativo de postulacion_panel_control.php
