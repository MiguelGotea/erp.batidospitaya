        ...
        <div class="sub-container">
                                        ...
                                        <?php if (verificarAccesoCargo([16])): ?>
                                            <td class="actions">
                                                ...
                                                <button class="btn btn-danger"
                                                    onclick="confirmarEliminarCategoria(<?= $categoria['idCategoria'] ?>, '<?= htmlspecialchars($categoria['NombreCategoria']) ?>')">
                ...
                <div class="section">
                    ...
                    <div class="form-inline" style="margin-bottom: 15px;">
                        <div class="form-group" style="flex: 1;">
                            ...
                            <input type="text" id="busquedaAsignaciones" placeholder="Nombre o Código"
                                onkeyup="buscarAsignaciones()">
                        </div>
                    </div>
                                ...
                                foreach ($todosOperarios as $operario):
                                    ...
                                    if ($operario['tiene_categoria']) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $operario['FechaFin'] ? formatoFecha($operario['FechaFin']) : 'Indefinido' ?>
                                            </td>
                                            <td>
                                                <?php if ($operario['FotoExamen']): ?>
                                                    <div class="photo-thumbnail">
                                                        <img src="<?= $rutaFoto ?>" alt="Foto examen"
                                            ...
                                            <td>
                                                ...
                                                <?php else: ?>
                                                    <span class="status-inactive"><i class="fas fa-times-circle"></i>
                                                        Inactiva</span>
                                                <?php endif; ?>
                                            </td>
                                            <td class="actions">
                                        ...
                                        '<?= $operario['FotoExamen'] ?>'
                                                ...
                                                <button style="display:none;" class="btn btn-danger"
                                                    onclick="confirmarEliminarAsignacion(<?= $operario['id'] ?>, '<?= $nombreCompleto ?>', '<?= htmlspecialchars($operario['NombreCategoria']) ?>')">
                                                    <i class="fas fa-trash"></i>
                                                </button>
                                            </td>
                                        </tr>
            ...
            <div id="modalAsignacion" class="modal-asignacion">
                <div class="modal-content-asignacion">
                    ...
                    <form id="formAsignacion" method="post" enctype="multipart/form-data"
                                ...
                                <select id="id_categoria_asignar" name="id_categoria" required>
                                    ...
                                    <?php foreach ($categorias as $categoria): ?>
                                        <option value="<?= $categoria['idCategoria'] ?>">
                                            <?= htmlspecialchars($categoria['NombreCategoria']) ?> (Peso:
                                            <?= $categoria['Peso'] ?>)
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                            ...
                            <div class="camera-container">
                                ...
                                <div style="margin-top:10px;">
                                    <label for="subirFoto" class="btn" style="display:inline-block;">
                                        ...
                                        <input type="file" id="subirFoto" name="foto_examen" accept="image/*"
                                ...
                                <div id="fotoAsignadaContainer" style="margin-top:15px; display:none;">
                                    ...
                                    <img id="fotoAsignada"
                                        style="max-width:100%; max-height:200px; border:1px solid #ddd; border-radius:5px;">
                                    <button type="button" onclick="eliminarFotoAsignada()" class="btn btn-danger"
                    ...
                    <form id="formEliminarCategoria" method="post">
                        ...
                        <div style="display: flex; justify-content: flex-end; gap: 10px; margin-top: 20px;">
                            <button type="button" class="btn btn-secondary"
                                onclick="cerrarModal('modalEliminarCategoria')">Cancelar</button>
            ...
            <div id="modalEliminarAsignacion" class="modal modal-confirmacion">
                <div class="modal-content">
                    ...
                    <form id="formEliminarAsignacion" method="post">
                        ...
                        <div style="display: flex; justify-content: flex-end; gap: 10px; margin-top: 20px;">
                            <button type="button" class="btn btn-secondary"
                                onclick="cerrarModal('modalEliminarAsignacion')">Cancelar</button>
                            <button type="submit" class="btn btn-danger">Eliminar</button>
                        </div>
                    </form>
                </div>
