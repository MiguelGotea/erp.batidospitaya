...
if (!(isset($_SESSION['usuario_rol']) && $_SESSION['usuario_rol'] === 'admin')) {
    verificarPermisoORedireccionar('nuevo_reclamo', 'vista', $cargoOperario);
}
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    // Verificar permiso de creación si no es admin
    if (!(isset($_SESSION['usuario_rol']) && $_SESSION['usuario_rol'] === 'admin') && !tienePermiso('nuevo_reclamo', 'crear', $cargoOperario)) {
        $_SESSION['errores'] = ["No tiene permisos para registrar nuevos reclamos."];
