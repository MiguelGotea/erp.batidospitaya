...
if (!tienePermiso('auditorias_desempeno', 'vista_interna', $cargoOperario) && !$esAdmin) {
...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT a.*, a.tipo_auditoria, a.promedio_exterior, a.promedio_interior, a.promedio_equipo, a.promedio_insumos, a.promedio_general, a.comentarios,
...
<body>
    ...
    <div style="text-align:center;">
        ...
        <div style="padding:30px;">
            ...
            <a href="generar_pdf_limpieza.php?id=<?php echo $registro['id']; ?>" id="btn-generar-pdf">Guardar como PDF</a>
