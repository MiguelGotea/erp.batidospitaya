            ...
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px; width: 100%; display:none;">
                <div class="encabezado-historial">
                    <h3 class="titulo-historial">
                        <i class="fas fa-history"></i> Historial de Auditorías - <?php echo $meses[$mes_seleccionado] . ' ' . $anio_seleccionado; ?>
                    </h3>
                </div>
            </div>
                        ...
                        <th style="text-align:center;">
                            <div class="filtro-contenedor">
                                ...
                                <div class="filtro-opciones">
                                    <a href="<?php echo $url_base; ?>sucursal=<?php echo urlencode($sucursal_seleccionada); ?>&mes=<?php echo $mes_seleccionado; ?>&anio=<?php echo $anio_seleccionado; ?>&tipo=todos">Todos</a>
                                    <a href="<?php echo $url_base; ?>sucursal=<?php echo urlencode($sucursal_seleccionada); ?>&mes=<?php echo $mes_seleccionado; ?>&anio=<?php echo $anio_seleccionado; ?>&tipo=limpieza">Limpieza</a>
                                    <a href="<?php echo $url_base; ?>sucursal=<?php echo urlencode($sucursal_seleccionada); ?>&mes=<?php echo $mes_seleccionado; ?>&anio=<?php echo $anio_seleccionado; ?>&tipo=personal">Personal</a>
                                    <a href="<?php echo $url_base; ?>sucursal=<?php echo urlencode($sucursal_seleccionada); ?>&mes=<?php echo $mes_seleccionado; ?>&anio=<?php echo $anio_seleccionado; ?>&tipo=servicio">Servicios</a>
                                </div>
                            </div>
                        </th>
                        ...
                        <tr>
                            ...
                            <td style="text-align:center;" class="columna-promedio">
                                <div style="text-align:center;" class="promedio-contenedor">
                                    ...
                                    <a href="<?php echo ($registro['tipo_auditoria'] == 'limpieza') ? 'ver_publico.php' : ($registro['tipo_auditoria'] == 'personal' ? 'verpersonal_publico.php' : 'verservicios_publico.php'); ?>?id=<?php echo $registro['id']; ?>" style="color:#51B8AC;">
