...
if (!isset($_SESSION['reporte_exitoso'])) {
    header("Location: reclamospend.php");
    exit();
}

$reporteId = $_SESSION['reporte_id'];
unset($_SESSION['reporte_exitoso'], $_SESSION['reporte_id']);
?>
...
<body>
    <div class="main-wrapper">
        ...
        <div class="container">
            ...
            <h1>Reporte de Investigación Registrado Exitosamente</h1>
            <p>El reporte ha sido guardado con el siguiente código:</p>
            <div class="reporte-id"><?php echo $reporteId; ?></div>
            <a href="reclamospend.php" class="btn">Reclamos Pendientes</a>
            <a href="index_avisos_publico.php" class="btn-agregar" target="_blank">
