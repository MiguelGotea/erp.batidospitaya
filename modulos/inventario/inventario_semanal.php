                        ...
                        <table class="table table-hover tabla-inventario mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th colspan="4">Inventario Semanal</th>
    ...
    <div class="modal fade" id="pageHelpModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content border-0 shadow-lg" style="border-radius:15px;">
                <div class="modal-header text-white" style="background:var(--pitaya-dark,#2d3748);border-radius:15px 15px 0 0;">
                ...
                <div class="modal-body p-4">
                        ...
                        <div class="col-md-6">
                            <div class="p-3 bg-light rounded-3 border h-100">
                                ...
                                <ul class="small text-muted mb-0">
                                    <li class="mb-1"><b>En Unidades:</b> Conteo físico en unidad básica de control (gramos, oz, unidades).</li>
                                    <li class="mb-1"><b>(A) En Presentación Envío:</b> Valor principal para el pedido. Si ingresas unidades, se calcula automáticamente ÷ factor de despacho.</li>
                                    <li class="mb-1">Al guardar, el sistema registra ambos valores en la BD para auditoría.</li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="p-3 bg-light rounded-3 border h-100">
                                <h6 class="fw-bold small mb-2"><i class="bi bi-calculator me-1"></i>2. Lógica del Pedido Sugerido</h6>
                                <ul class="small text-muted mb-0">
                                    <li class="mb-1"><b>Cons. Semanal:</b> <code>Promedio + Desviación Estándar</code> sobre la Ventana Activa.</li>
                                    <li class="mb-1"><b>Stock Máximo (B):</b> <code>Consumo Diario × (Ciclo + Desfase + Stock Mín)</code> ÷ Factor Despacho.</li>
                                    <li class="mb-1"><b>Pedido Sugerido:</b> <code>B − A</code> (en unidades de despacho).</li>
                                    <li class="mb-1">Los ceros al inicio/fin del periodo se excluyen automáticamente (Ventana Activa).</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-4 p-3 rounded-3 border" style="background:#f0fdf4;border-color:#86efac !important;">
                        ...
                        <div class="p-2 rounded-2 mb-2 border" style="background:#fff7ed;border-color:#fdba74 !important;">
                            <div class="fw-bold small mb-1" style="color:#9a3412;"><i class="bi bi-bezier2 me-1"></i>Conversiones Transitivas — Floyd-Warshall</div>
                            <p class="small text-muted mb-0">El sistema resuelve cadenas multi-salto (oz → gr → kg) automáticamente. No es necesario tener la fila directa <em>oz → kg</em>; basta con las conversiones intermedias y el algoritmo las encadena en memoria.</p>
                        </div>
                        <div class="p-2 rounded-2 mb-2 border" style="background:#fefce8;border-color:#fde68a !important;">
                            ...
                            <p class="small text-muted mb-0">Fijar un <b>yield factor conservador</b> (ej: 1 naranja = 2.0 oz, el mínimo del rango real). La variabilidad queda absorbida por la desviación estándar del consumo. Agregar la conversión en <code>conversion_unidad_producto</code>.</p>
                        </div>
                    ...
                    <div>
                        <h6 class="fw-bold text-dark small border-bottom pb-2">3. Desglose de Despachos (Pedidos 1, 2 y 3)</h6>
                        <p class="small text-muted">El pedido total se divide según la categoría y los porcentajes configurados por sucursal:</p>
                        <div class="table-responsive">
                            <table class="table table-sm table-bordered small">
                                <thead class="table-light">
                                    <tr><th>Categorías</th><th>Lógica</th></tr>
                                </thead>
                                <tbody>
                                    <tr><td><b>B, D, F</b></td><td>Pedido 1 = % Congelados. Pedido 2 = el resto.</td></tr>
                                    <tr><td><b>A, C</b></td><td>Pedido 1 = % Frescos. Pedido 2 = el resto.</td></tr>
                                    <tr><td><b>E, G</b></td><td>100% en Pedido 1.</td></tr>
                                </tbody>
                            </table>
                        </div>
                    </div>
