...
<head>
    ...
    <meta name="description"
        content="Configuración del plan de despacho por sucursal y categoría de insumo para el ERP Batidos Pitaya.">
...
<body>
        ...
        <div class="sub-container">
            ...
            <div class="container-fluid p-3">
                ...
                <div id="mainLayout" style="display:none;" class="row g-3">
                    ...
                    <div class="col-md-3 col-lg-2">
                        <div class="w-100 h-100 position-relative" style="min-height: 250px;">
                            <div class="pdg-sidebar-wrapper pdg-tab-content d-flex flex-column"
                                style="padding: 1.25rem;">
                                <h6 class="mb-3 fw-bold" style="color: var(--pdg-green);"><i
                                        class="bi bi-shop me-2"></i>Tiendas</h6>
                                <div class="list-group pdg-store-list flex-grow-1" id="sucursalesList"
                ...
                <div id="sinSucursales" style="display:none;" class="pdg-empty-state">
                    ...
                    <p class="text-muted small">No se encontraron sucursales configuradas como activas en el sistema.
                    </p>
                </div>
    ...
    <div id="tooltipAncla" class="d-none">
        Ingresa el número de semana de un despacho real ya ocurrido. Ej: si la semana 540 fue el último despacho,
        escribe 540. El sistema usa esto para calcular si la semana actual "toca" según el intervalo configurado.
    </div>

    <!-- Modal Configuración Stock Mínimo G -->
    <div class="modal fade" id="modalConfigStockMinimoG" tabindex="-1" aria-labelledby="modalConfigStockMinimoGLabel"
        aria-hidden="true" data-bs-backdrop="static">
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content border-0 shadow">
                <div class="modal-header bg-primary text-white" style="background-color: var(--pdg-green) !important;">
                    <h5 class="modal-title" id="modalConfigStockMinimoGLabel"><i class="bi bi-box-seam me-2"></i>Stock
                        Mínimo: Grupo G (<span id="stockMinimoGSucursalNombre"></span>)</h5>
                            ...
                            <table class="table table-hover table-sm mb-0 align-middle">
                                <thead class="table-light sticky-top">
                                    <tr>
                                        ...
                                        <th style="width:180px;" class="pe-3 border-0">Stock Mínimo</th>
                                    </tr>
                                </thead>
