...
/* ============================================================
   ...
   Igual que dashboard_consumo_auditoria.php pero con permiso
   balance_inventario_access_host (usado desde el detalle de balance).
...
try {
    ...
    /* ── PASO A: CodIngredientes vía Cotizaciones ─────────── */
    $codIngs = [];
    if (!empty($codCots)) {
