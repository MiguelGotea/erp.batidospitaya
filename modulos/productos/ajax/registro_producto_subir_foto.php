...
try {
    ...
    $dirUpload = '../uploads/productos/' . $idProducto . '/fotos/';
    if (!is_dir($dirUpload)) {
    ...
    // Guardar en BD
    $rutaRelativa = 'modulos/POS/uploads/productos/' . $idProducto . '/fotos/' . $nombreArchivo;
    
    $sql = "INSERT INTO fotos_presentacion_producto 
