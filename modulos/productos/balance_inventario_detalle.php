        ...
        <div class="sub-container">
            ...
            <div class="bi-wrapper">
                ...
                <div id="bdHeaderCard" class="bd-header-card" style="display:none">
                    <div>
                        <div
                            style="font-size:.75rem;color:#51B8AC;text-transform:uppercase;letter-spacing:.1em;margin-bottom:.3rem;font-weight:700">
                            Detalle Analítico de Producto</div>
                ...
                <div id="bdConsumoTeoWrap" class="bd-section" style="display:none">
                    <div class="bd-section-title bd-sec-consumo_teo">
                        ...
                        <span
                            style="margin-left:.5rem;font-size:.72rem;opacity:.6;font-weight:400;font-style:italic">Auditoría
                            Venta × Venta</span>
                        <span id="bdCteoSubtitle"
                            style="margin-left:auto;font-size:.72rem;opacity:.7;font-weight:600">Cargando…</span>
                    </div>
                    <div class="bd-sec-wrap">
                        <div id="bdCteoLoader" class="text-center py-4">
                            <div class="spinner-border" role="status" style="width:1.4rem;height:1.4rem;color:#e65100">
                            </div>
