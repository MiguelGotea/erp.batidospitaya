                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-end bg-light-gray col-num align-bottom"
                                                title="Promedio de consumo semanal">Prom./Sem.</th>
                                            ...
                                            <th class="text-end bg-light-gray col-num align-bottom text-muted"
                                                ...
                                                style="font-weight: 600;">Cons. Diario</th>
                                            ...
                                            <th class="text-end bg-mid-gray col-num align-bottom"
                                                ...
                                                style="color: var(--pitaya-dark);">Stock Máx Final</th>

                                            <th class="text-center col-pronostico align-bottom"
                                                title="Próximo despacho de esta categoría según el plan">Próx. Despacho
                                            </th>
                                            <th class="text-end col-pronostico col-num align-bottom"
                                                title="Stock estimado al cierre del día anterior al despacho">Stock
                                                Pronóst. D-1</th>
                                            <th class="text-center col-pronostico col-num align-bottom text-primary"
