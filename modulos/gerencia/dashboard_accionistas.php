...
if (!tienePermiso('dashboard_accionistas', 'vista', $cargoOperario)) {
...
<head>
    ...
    <title>Dashboard Accionistas · Batidos Pitaya</title>
    <meta name="description" content="Panel ejecutivo para mesa de socios y accionistas — KPIs estratégicos de Batidos Pitaya.">
    ...
    <link rel="stylesheet" href="css/dashboard_accionistas.css?v=<?php echo mt_rand(1, 10000); ?>">
</head>
...
<body id="dashboardAccionistas">
                ...
                <div class="da-kpi-grid" id="gridVentas">
                    ...
                    <div class="da-kpi-card da-kpi-primary" id="cardVentasTotales">
                        ...
                        <div class="da-kpi-body">
                            <div class="da-kpi-label">Ventas Totales</div>
    ...
    <script>
        const DA_CONFIG = {
            ajaxUrl: 'ajax/dashboard_accionistas_get_datos.php',
            mesActual: <?php echo $mesActual; ?>,
            anioActual: <?php echo $anioActual; ?>,
            hoy: '<?php echo $hoy; ?>'
        };
    </script>
    <script src="js/dashboard_accionistas.js?v=<?php echo mt_rand(1, 10000); ?>"></script>
</body>
