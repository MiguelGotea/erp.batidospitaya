<?php
/**
 * AJAX — Dashboard Accionistas · Obtiene todos los KPIs
 * modulos/gerencia/ajax/dashboard_accionistas_get_datos.php
 */
...
try {
    ...
    $sqlVentas = "
        SELECT
            ...
            SUM(CASE WHEN Anulado = 0 THEN Precio / 7 ELSE 0 END)                    AS ventas_usd,
    ...
    $ventasUSD     = round($ventas['ventas_usd'] ?? 0, 2);
