                    ...
                    <div class="modal-body p-3 bg-light">
                        <form id="formNuevaVacacion" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="date" id="nueva_fecha_fin" name="fecha_fin" class="form-control" required
                                        onchange="actualizarInfoRangoVacacion()">
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label for="nueva_dias_intervalo"
                                        class="form-label small fw-bold text-muted text-uppercase">Días Vacaciones:</label>
                                    <input type="text" id="nueva_dias_intervalo" class="form-control bg-light" readonly
                                        value="0">
                                </div>
                            </div>
                            ...
                            <div class="mb-3" style="display:none;">
                                <label for="nueva_tipo"
                                    class="form-label small fw-bold text-muted text-uppercase">Tipo:</label>
            ...
            <div class="fab-options">
                ...
                <?php if ($esContabilidad): ?>
                    <a id="btn-exportar-faltas" href="ver_marcaciones_todas_nuevo.php?<?= http_build_query([
                        ...
                        <div class="fab-icon-holder"><i class="fas fa-user-slash"></i></div>
                    </a>
                    ...
                    <a href="exportar_tardanzas_detalle.php?<?= http_build_query([
                        ...
                        <div class="fab-icon-holder"><i class="fas fa-list"></i></div>
                    </a>
                <?php endif; ?>
                <?php if (isset($esSolicitudVacaciones) && $esSolicitudVacaciones): ?>
