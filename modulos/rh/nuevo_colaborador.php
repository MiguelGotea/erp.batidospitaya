        ...
        <div class="form-container">
            ...
            <div style="display:none;" class="info-box">
                ...
                <ul>
                    ...
                    <li>El usuario con las primeras 2 letras del nombre + primeras 2 letras del apellido + últimos 4 dígitos de cédula</li>
                    <li>La clave con las primeras 2 letras del nombre + primeras 2 letras del apellido + fecha actual (ddmmyy)</li>
                    <li>El estado del colaborador se establecerá como "Activo"</li>
                    <li>Se registrará que fue creado por: <?= $esAdmin ? htmlspecialchars($usuario['nombre']) : htmlspecialchars($usuario['Nombre'].' '.$usuario['Apellido']) ?> (ID: <?= $usuarioActualId ?>)</li>
            ...
            <div class="preview-box">
                ...
                <div style="display:none;" class="registrado-por">
                    Registrado por: <?= $esAdmin ? htmlspecialchars($usuario['nombre']) : htmlspecialchars($usuario['Nombre'].' '.$usuario['Apellido']) ?>
                </div>
            </div>
            ...
            <form method="post" action="nuevo_colaborador.php">
                <div class="form-row">
                    ...
                    <div class="form-col">
                        <div class="form-group">
                            ...
                            <input type="text" id="Nombre2" name="Nombre2" value="<?= htmlspecialchars($valores['Nombre2']) ?>">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-col">
                        <div class="form-group">
                            ...
                            <input type="text" id="Apellido" name="Apellido" value="<?= htmlspecialchars($valores['Apellido']) ?>" required>
                        </div>
                    </div>
                    <div class="form-col">
                        <div class="form-group">
                            <label for="Apellido2">Segundo Apellido</label>
                            <input type="text" id="Apellido2" name="Apellido2" value="<?= htmlspecialchars($valores['Apellido2']) ?>">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="Cedula" name="Cedula" value="<?= htmlspecialchars($valores['Cedula']) ?>" 
                           required pattern="[0-9]{3}-[0-9]{6}-[0-9]{4}[A-Za-z]?" 
                           title="Formato: 001-234567-8910A" 
                           placeholder="001-234567-8910A"
                           maxlength="16">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="Celular" name="Celular" 
                           value="<?= htmlspecialchars($valores['Celular']) ?>" 
                ...
                <div class="form-row">
                    <div class="form-col">
                        <div class="form-group">
                            ...
                            <input readonly type="text" id="usuario" name="usuario" value="<?= htmlspecialchars($valores['usuario']) ?>" placeholder="Se generará automáticamente">
                        </div>
                    </div>
                    <div class="form-col">
                        <div class="form-group">
                            <label for="clave">Clave</label>
                            <input readonly type="text" id="clave" name="clave" value="<?= htmlspecialchars($valores['clave']) ?>" placeholder="Se generará automáticamente">
                        </div>
                    </div>
                </div>
