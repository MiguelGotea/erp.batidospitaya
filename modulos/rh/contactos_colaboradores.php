...
<body>
    <div class="container">
        <header>
            <div class="header-container">
                ...
                <div class="buttons-container">
                    <a href="colaboradores.php" class="btn-agregar">
                        <i class="fas fa-users"></i> <span class="btn-text">Lista Colaboradores</span>
                    </a>

                    <a href="nuevo_colaborador.php" class="btn-agregar">
                        <i class="fas fa-user-plus"></i> <span class="btn-text">Agregar</span>
                    </a>

                    <a href="contactos_colaboradores.php" class="btn-agregar activo">
        ...
        <h1 class="title">Contactos de Colaboradores</h1>
