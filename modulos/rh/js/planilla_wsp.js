...
/**
 * Realiza una prueba de envío directo para verificar conexión
 */
async function probarEnvio() {
    const instancia = 'wsp-planilla';
    ...
    const { value: formValues } = await Swal.fire({
        ...
        html: `
            <div class="text-start">
                ...
                <textarea id="swal-input-msg" class="form-control" rows="2">Prueba de conexión Pitaya WhatsApp ⚡ desde Planilla</textarea>
            </div>
        `,
        focusConfirm: false,
        showCancelButton: true,
