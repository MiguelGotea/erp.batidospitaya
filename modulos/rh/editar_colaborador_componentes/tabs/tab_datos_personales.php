                        <?php if (tienePermiso('editar_colaborador', 'edicion', $cargoId)): ?>
                                <div id="datos-personales"
                                    ...
                                    <form method="POST" action="">
                                        ...
                                        <div
                                            style="margin-top: 25px; padding: 20px; background: #f8fbfb; border-radius: 12px; border: 1px solid #51B8AC33;">
                                            <h4
                                                style="margin: 0 0 15px 0; color: #0E544C; font-size: 0.9rem; font-weight: 800; text-transform: uppercase; display: flex; align-items: center; gap: 10px;">
