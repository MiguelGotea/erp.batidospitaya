                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr style="border-bottom: 1px solid #ddd;">
                                            ...
                                            <td style="padding: 10px;" class="editable-cell" data-field="CodNivelesCargos"
                                                data-id="<?= $adendum['CodAsignacionNivelesCargos'] ?>" data-type="select"
                                                data-current="<?= $adendum['CodNivelesCargos'] ?>">
                                                <span
                                                    class="cell-display"><?= htmlspecialchars($adendum['nombre_cargo'] ?? 'No definido') ?></span>
                                            </td>
...
<style>
    ...
    .editable-cell.editing {
        ...
        /* Slightly reduced to compensate for input border/padding */
    }
