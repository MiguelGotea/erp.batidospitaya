...
function determinarColorIndicadorContratos($contratos) {
    if (empty($contratos)) return 'verde'; // Verde cuando no hay contratos
    ...
    if ($diasMinimos <= 7) return 'rojo';      // Menos de 1 semana
    if ($diasMinimos <= 15) return 'amarillo'; // Menos de 15 días
            ...
            <div class="indicadores-container">
                ...
                <div class="indicator-container"  onclick="mostrarModalTardanzasRH()" style="cursor: pointer;">  
                    ...
                    <div class="indicator-info">
                        ...
                        <div class="indicator-meta">
                            <span>
                                <span class="indicator-status tardanzas-indicador <?= $tardanzasPendientesRH['color'] ?>" id="tardanzasFechaRH">
                                    Mes Actual
                                </span>
                            </span>
                            <span class="indicator-action">
                 ...
                 <div class="indicator-container"  onclick="mostrarModalFaltasRH()" style="cursor: pointer;">  
                    ...
                    <div class="indicator-info">
                        ...
                        <div class="indicator-meta">
                            <span>
                                <span class="indicator-status faltas-indicador <?= $faltasPendientesRH['color'] ?>" id="faltasFechaRH">
                                    Mes Actual
                                </span>
                            </span>
                            <span class="indicator-action">
                ...
                <?php if ($esAdmin || verificarAccesoCargo([13, 16, 39, 30, 37])): ?>
                     <div class="indicator-container"  onclick="mostrarModalAusenciasColaboradores()" style="cursor: pointer;">  
                        <div class="indicator-header">
                            <div class="indicator-icon">
                                <i class="fas fa-stopwatch"></i>
                            </div>
                        ...
                        <div class="indicator-info">
                            ...
                            <div class="indicator-meta">
                                <span>
                                    <span class="indicator-status <?= $colorIndicadorAusenciasColab ?>" id="ausenciasColabFecha">
                ...
                <div class="modal-content-pendientes">
                    ...
                    <div class="modal-body-pendientes">
                        <div style="display:none;" class="info-fecha-limite">
                            <p><strong>Total de contratos próximos a vencer:</strong> <span id="totalContratosInfo">0</span></p>
                ...
                <div class="modal-content-pendientes">
                    ...
                    <div class="modal-body-pendientes">
                        <div class="info-fecha-limite">
                            <p><strong>Total de colaboradores con ausencias:</strong> <span id="totalAusenciasColabInfo"><?= $totalAusenciasColaboradores ?></span></p>
                            <p><strong>Criterio:</strong> 3 o más días consecutivos con estado <strong>"Activo" u "Otra.Tienda"</strong> en horario programado y SIN marcación</p>
                ...
                <div class="modal-content-pendientes" style="max-width: 90%;">
                    ...
                    <div class="modal-body-pendientes">
                        <div class="filtros-modal" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px;">
                            ...
                            <a href="<?= $tardanzasPendientesRH['url_tardanzas'] ?>" class="btn-ver-detalles" target="_blank">
