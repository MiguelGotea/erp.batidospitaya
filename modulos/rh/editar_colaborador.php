    ...
    try {
        ...
        if ($esEdicionReal && $contratoActual) {
            ...
            */
            ...
            $stmtAsignacion = $conn->prepare("
                INSERT INTO AsignacionNivelesCargos (CodOperario, CodNivelesCargos, Fecha, Sucursal, CodTipoContrato, cod_usuario_creador)
                VALUES (?, ?, ?, ?, ?, ?)
            ");
            $stmtAsignacion->execute([
                $codOperario,
        ...
        SELECT 
            ...
            COALESCE(
                (SELECT nc.Nombre 
                 ...
                 AND DATE(anc.Fecha) <= c.inicio_contrato 
                 AND (anc.Fin IS NULL OR DATE(anc.Fin) >= c.inicio_contrato)
...
function obtenerExpedienteDigitalCompleto($codOperario) {
    ...
    $stmt = $conn->prepare("
        SELECT 
            ...
            CASE 
                WHEN a.cod_adendum_asociado IS NOT NULL THEN CONCAT('Adendum - ', oc.TipoAdendum, ' (', DATE_FORMAT(oc.FechaInicio, '%d/%m/%Y'), ')')
                ...
                <?php if ($esAdmin || verificarAccesoCargo([13, 16, 39, 30, 37, 28])): ?>
                    <div id="datos-personales" class="tab-pane <?= $pestaña_activa == 'datos-personales' ? 'active' : '' ?>">
                                ...
                                <div class="form-col">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="genero" name="genero" class="form-control">
                                            ...
                                            <option value="M" <?= (isset($colaborador['Genero']) && $colaborador['Genero'] == 'M') ? 'selected' : '' ?>>Masculino</option>
                                            <option value="F" <?= (isset($colaborador['Genero']) && $colaborador['Genero'] == 'F') ? 'selected' : '' ?>>Femenino</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div style="margin-top: 40px; border-top: 2px solid #6c757d; padding-top: 20px;">
                                    ...
                                    <table style="width: 100%; border-collapse: collapse;">
                                        <thead>
                                            <tr style="background-color: #6c757d; color: white;">
                                                ...
                                                <th style="padding: 10px; text-align: left; display:none;">Tamaño</th>
                            ...
                            <?php else: ?>
                                <p style="text-align: center; color: #6c757d; padding: 20px;">No hay archivos adjuntos</p>
                            <?php endif; ?>
                        </div>
                    </div>
                <?php endif; ?>
                                ...
                                <div class="form-col">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="frecuencia_pago" name="frecuencia_pago" class="form-control" required>
                                            <option value="quincenal" <?= (!$mostrarFormularioNuevoContrato && $contratoActual && ($contratoActual['frecuencia_pago'] ?? 'quincenal') == 'quincenal') ? 'selected' : '' ?>>Quincenal</option>
                                    ...
                                    <table style="width: 100%; border-collapse: collapse; margin-top: 15px;">
                                        <thead>
                                            <tr style="background-color: #6c757d; color: white;">
                                                ...
                                                <th style="padding: 10px; text-align: left; display:none;">Categoría</th>
                                                ...
                                                <th style="padding: 10px; text-align: center;">% Docs Obligatorios</th>
                                                <th style="padding: 10px; text-align: center;"></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                ...
                <?php if ($esAdmin || verificarAccesoCargo([13, 16, 39, 30, 37, 28])): ?>
                    <div id="movimientos" class="tab-pane <?= $pestaña_activa == 'movimientos' ? 'active' : '' ?>">
                        ...
                        <div style="border-top: 2px solid #0E544C; padding-top: 20px;">
                            ...
                            <?php else: ?>
                                <p style="text-align: center; color: #6c757d; padding: 20px;">No hay historial de cargos</p>
                            <?php endif; ?>
                        </div>
                    </div>
                <?php endif; ?>
                                    ...
                                    <table style="width: 100%; border-collapse: collapse;">
                                        <thead>
                                            <tr style="background-color: #0E544C; color: white;">
                                                ...
                                                <th style="padding: 10px; text-align: left;">Fecha Inicio</th>
                                                <th style="padding: 10px; text-align: left;">Fecha Fin</th>
                                                <th style="padding: 10px; text-align: left; display:none;">Estado</th>
                                                <th style="padding: 10px; text-align: center;"></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                                            ...
                                                            <tr style="border-bottom: 1px solid #dee2e6;">
                                                                <td style="padding: 12px;">
                                                                    ...
                                                                    <?php else: ?>
                                                                        ...
                                                                        <?php else: ?>
                                                                            <span style="color: #6c757d; font-style: italic;">Sin tipo</span>
                                                                        <?php endif; ?>
                                                                    <?php endif; ?>
                                                                </td>
                                                                <td style="padding: 12px;">
                ...
                <?php if ($esAdmin || verificarAccesoCargo([13, 16, 39, 30, 37, 28])): ?>
                    <div id="bitacora" class="tab-pane <?= $pestaña_activa == 'bitacora' ? 'active' : '' ?>">
                        ...
                        <div style="border-top: 2px solid #0E544C; padding-top: 20px;">
                            ...
                            <?php else: ?>
                                <div style="text-align: center; padding: 40px; color: #6c757d;">
                                    <i class="fas fa-clipboard" style="font-size: 3rem; margin-bottom: 15px; opacity: 0.3;"></i>
                                    <p>No hay anotaciones en la bitácora</p>
                                    <p style="font-size: 0.9em;">Las anotaciones aparecerán aquí una vez que se registren</p>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
