                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <select class="form-select form-select-sm" id="registrosPorPagina"
                                    style="width:auto" onchange="cargarDatos(1)">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <ul class="nav nav-tabs mb-3" id="tabsDetalle">
                    <li class="nav-item">
                        <a class="nav-link active" id="tab-pedido-link" href="#" onclick="verDetallePedido('pedido'); return false;">
                            <i class="bi bi-receipt me-1"></i>Detalle Pedido a Anular
                        </a>
                    </li>
                    <li class="nav-item" id="tabCambioItem" style="display:none">
                        <a class="nav-link" id="tab-cambio-link" href="#" onclick="verDetallePedido('cambio'); return false;">
                ...
                <hr>
                <div class="mb-2">
                    <label class="form-label small fw-semibold">Comentario de decisión <span class="text-muted">(opcional)</span></label>
        ...
        <div class="modal-content border-0 shadow">
            ...
            <div class="modal-body">
                        ...
                        <div class="card h-100 border-0 bg-light">
                            <div class="card-body">
                                ...
                                <p class="small text-muted mb-0">
                                    ...
                                    Compara el <strong>Pedido a Anular</strong> y el <strong>Pedido de Cambio</strong> con el motivo declarado.
                        ...
                        <div class="card h-100 border-0 bg-light">
                            <div class="card-body">
                                ...
                                <p class="small text-muted mb-0">
                                    ...
                                    <strong>aprobar</strong>: Aprobar / Rechazar solicitudes y crear anulaciones web.
                ...
                <div class="alert alert-info py-2 px-3 small">
                    ...
                    La tabla se actualiza automáticamente cada 60 segundos para mostrar nuevas solicitudes en tiempo real.
                </div>
            </div>
        </div>
    </div>
