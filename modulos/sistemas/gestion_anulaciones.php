 ...
 * Estándar ERP Batidos Pitaya · filtros de encabezado · FAB flotante
 */
...
<body>
    ...
    <div class="main-container">
        <div class="sub-container">
            ...
            <div class="container-fluid p-3">
                ...
                <!-- ── Tabla con filtros de encabezado ─────── -->
                <div class="table-responsive">
                    <table class="table table-hover anulaciones-table" id="tablaAnulaciones">
                        <thead>
                            <tr>
                                ...
                                <th data-column="CodPedidoCambio" data-type="text">
                                    Cambio
                                    <i class="bi bi-funnel filter-icon" onclick="toggleFilter(this)"></i>
                                </th>
                ...
                <div class="d-flex justify-content-between align-items-center mt-3">
                    ...
                    <div class="d-flex align-items-center gap-3">
                        <span class="small text-muted">
                            <i class="bi bi-arrow-repeat me-1"></i>Refresh en <span id="countdown">60</span>s
                        </span>
    ...
    <!-- ── FAB Flotante (Nueva Anulación Web) ──────────────── -->
    <?php if ($puedeAprobar): ?>
    <a href="#" class="btn-floating-pitaya" title="Nueva Anulación Web" onclick="abrirModalNuevaAnulacion(); return false;">
        <i class="fas fa-plus"></i>
    </a>
    <?php endif; ?>

    <!-- ═══════════════════════════════════════════════════════
         MODAL DE DECISIÓN (Ver / Aprobar / Rechazar)
    ════════════════════════════════════════════════════════ -->
            ...
            <div class="modal-content">
                <div class="modal-header" style="background:#0E544C; color:#fff;">
                    <h5 class="modal-title">
                        <i class="bi bi-clipboard-check me-2"></i>Revisar Solicitud de Anulación
                    </h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-4">
                            <div class="card border-0 bg-light text-center p-2">
                                <div class="small text-muted">Pedido a Anular</div>
                                <div class="fw-bold fs-3 text-danger" id="dec_codPedido">—</div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="card border-0 bg-light text-center p-2">
                                <div class="small text-muted">Pedido de Cambio</div>
                                <div class="fw-bold fs-3 text-primary" id="dec_codCambio">—</div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="card border-0 bg-light text-center p-2">
                                <div class="small text-muted">Sucursal</div>
                                <div class="fw-bold fs-3" style="color:#0E544C" id="dec_sucursal">—</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="detallePlaceholder" class="text-center py-4 text-muted">
                        <div class="spinner-border spinner-border-sm"></div> Cargando detalle del pedido...
                    </div>
                    ...
                    <div class="mb-2">
                        <label class="form-label small fw-semibold">
                            Comentario de decisión <span class="text-muted">(opcional)</span>
                        </label>
                ...
                <div class="modal-footer border-0">
                    ...
                    <button class="btn-modern btn-modern-primary" id="btnAprobar"
                ...
                <div class="modal-body">
                    <div class="row g-3 mb-3">
                        <div class="col-md-4">
                            ...
                            <select class="form-select form-select-sm" id="new_sucursal">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group input-group-sm">
                                <input type="number" class="form-control" id="new_codPedido" placeholder="Ej: 1234"
                                    onkeydown="if(event.key==='Enter') buscarPedidoWeb()">
                    ...
                    <div id="newPedidoEmpty" class="text-center text-muted py-3" style="display:none">
                        ...
                        <div class="small mt-1">No se encontró el pedido en el historial.</div>
                    </div>
                </div>
                <div class="modal-footer border-0">
            ...
            <div class="modal-content border-0 shadow">
                ...
                <div class="modal-body">
                            ...
                            <div class="card h-100 border-0 bg-light">
                                <div class="card-body">
                                    ...
                                    <p class="small text-muted mb-0">
                                        Las tiendas envían solicitudes desde Access (Status=0 = Pendiente).
                                        El panel ERP las muestra para aprobar o rechazar.
                                        Access detecta la resolución cada 60s y ejecuta la anulación localmente
                                        marcando <strong>EjecutadoEnTienda</strong>.
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card h-100 border-0 bg-light">
                                <div class="card-body">
                                    <h6 class="text-success border-bottom pb-2 fw-bold">
                                        <i class="fas fa-check-circle me-2"></i>Cómo Aprobar / Rechazar
                                    </h6>
                                    <p class="small text-muted mb-0">
                                        Haz clic en <i class="bi bi-eye"></i> para ver el detalle del pedido.
                                        Compara el <strong>Pedido a Anular</strong> y el <strong>Pedido de Cambio</strong>
                                        con el motivo declarado. Luego elige <em>Aprobar</em> o <em>Rechazar</em>.
                                        También puedes usar los botones rápidos ✓ ✗ en la tabla.
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card h-100 border-0 bg-light">
                                <div class="card-body">
                                    <h6 class="text-warning border-bottom pb-2 fw-bold">
                                        <i class="fas fa-globe me-2"></i>Nueva Anulación Web (FAB +)
                                    </h6>
                                    <p class="small text-muted mb-0">
                                        El botón flotante <strong>+</strong> permite crear una solicitud directamente
                                        desde el ERP sin necesitar Access. Busca el pedido por número y sucursal,
                                        agrega el motivo y envía. Access la ejecutará en su próximo ciclo (≈60s).
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <div class="card h-100 border-0 bg-light">
                                <div class="card-body">
                                    ...
                                    <p class="small text-muted mb-0">
                                        Haz clic en el ícono <i class="bi bi-funnel"></i> de cualquier columna para
                                        filtrar por texto, lista o rango de fechas. Un punto rojo indica
                                        filtro activo. Los filtros se acumulan y se aplican en tiempo real.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="alert alert-info py-2 px-3 small mb-0">
                        <strong><i class="fas fa-info-circle me-1"></i>Permisos:</strong>
                        <strong>vista</strong> — ver solicitudes. &nbsp;|&nbsp;
                        <strong>aprobar</strong> — aprobar/rechazar y crear anulaciones web.
                        El auto-refresh actualiza la tabla cada 60s automáticamente.
                    </div>
                </div>
            </div>
        </div>
